...
ActiveRecord::Schema.define(version: 20170416184711) do
  ...
  create_table "photographs", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["account_id"], name: "index_photographs_on_account_id", using: :btree
    t.index ["created_at"], name: "index_photographs_on_created_at", using: :btree
    t.index ["project_id"], name: "index_photographs_on_project_id", using: :btree
    t.index ["updated_at"], name: "index_photographs_on_updated_at", using: :btree
  end
  ...
  create_table "polishes", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["brand_id"], name: "index_polishes_on_brand_id", using: :btree
